...
import {
  ...
  AdminQuizHub, AdminQuizCategories, AdminQuizQuestions, AdminQuizMatches,
...
function AppInner() {
  ...
  const renderPage = () => {
    ...
    if (isAdmin) {
      ...
      if (page === "admin_quiz")             return <AdminQuizHub setPage={setPage} showToast={showToast} />;
      if (page === "admin_quiz_categories")  return <AdminQuizCategories showToast={showToast} onBack={() => setPage("admin_quiz")} />;
      if (page === "admin_quiz_questions")   return <AdminQuizQuestions showToast={showToast} onBack={() => setPage("admin_quiz")} />;
      if (page === "admin_quiz_matches")     return <AdminQuizMatches showToast={showToast} onBack={() => setPage("admin_quiz")} />;
    ...
    switch (page) {
      ...
      case "game_quizbattle": return <QuizBattleGame {...props} />;
